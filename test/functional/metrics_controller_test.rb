...
class MetricsControllerTest < ActionController::TestCase
  ...
  test "metrics" do
    ...
    assert_select "#cost_hhrr_spent_1", "19910.0 €"
    assert_select "#cost_hhrr_spent_2", "12280.0 €"
    ...
    assert_select "#cost_total_spent_1", "19910.0 €"
    assert_select "#cost_total_spent_2", "12280.0 €"
    assert_select "#cost_hhrr_remaining_0", "32702.5 €"
    assert_select "#cost_hhrr_remaining_1", "37590.0 €"
    assert_select "#cost_hhrr_remaining_2", "34220.0 €"
    ...
    assert_select "#cost_total_remaining_1", "37590.0 €"
    assert_select "#cost_total_remaining_2", "34220.0 €"
    ...
    assert_select "#profitability_current_1", "103546.0 € (83.87 %)"
    assert_select "#profitability_current_2", "111176.0 € (90.05 %)"
