...
class MetricsControllerTest < ActionController::TestCase
  ...
  test "metrics" do
    ...
    assert_equal css_select("#effort_done_total_0 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:2.93,9.16,14.65,29.3,25.64,18.32&chl=JP: 2.93%|AF: 9.16%|AP: 14.65%|PS: 29.3%|PJ: 25.64%|B: 18.32%" />'
    assert_equal css_select("#effort_done_total_1 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:3.15,9.14,14.62,29.24,25.58,18.27&chl=JP: 3.15%|AF: 9.14%|AP: 14.62%|PS: 29.24%|PJ: 25.58%|B: 18.27%" />'
    assert_equal css_select("#effort_done_total_2 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:3.3,9.12,14.6,29.19,25.54,18.25&chl=JP: 3.3%|AF: 9.12%|AP: 14.6%|PS: 29.19%|PJ: 25.54%|B: 18.25%" />'
    ...
    assert_equal css_select("#effort_remaining_total_0 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:4.5,10.92,15.63,31.26,25.05,12.64&chl=JP: 4.5%|AF: 10.92%|AP: 15.63%|PS: 31.26%|PJ: 25.05%|B: 12.64%" />'
    assert_equal css_select("#effort_remaining_total_1 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:4.15,10.67,15.5,31.0,25.17,13.51&chl=JP: 4.15%|AF: 10.67%|AP: 15.5%|PS: 31.0%|PJ: 25.17%|B: 13.51%" />'
    assert_equal css_select("#effort_remaining_total_2 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:2.94,9.08,15.34,30.69,23.79,18.16&chl=JP: 2.94%|AF: 9.08%|AP: 15.34%|PS: 30.69%|PJ: 23.79%|B: 18.16%" />'
    ...
    assert_equal css_select("#effort_planned_total_0 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:3.8,10.13,15.19,30.38,25.32,15.19&chl=JP: 3.8%|AF: 10.13%|AP: 15.19%|PS: 30.38%|PJ: 25.32%|B: 15.19%" />'
    assert_equal css_select("#effort_planned_total_1 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:3.8,10.13,15.19,30.38,25.32,15.19&chl=JP: 3.8%|AF: 10.13%|AP: 15.19%|PS: 30.38%|PJ: 25.32%|B: 15.19%" />'
    assert_equal css_select("#effort_planned_total_2 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chs=220x50&chd=t:3.03,9.09,15.15,30.3,24.24,18.18&chl=JP: 3.03%|AF: 9.09%|AP: 15.15%|PS: 30.3%|PJ: 24.24%|B: 18.18%" />'
    ...
    assert_equal css_select("#time_chart_0 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:33.15|100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x50&chxt=x,y&chxl=0:|0|50|100|1:|33.15% |" />'
    assert_equal css_select("#time_chart_1 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:23.2|100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x50&chxt=x,y&chxl=0:|0|50|100|1:|23.2% |" />'
    assert_equal css_select("#time_chart_2 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:9.33|100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x50&chxt=x,y&chxl=0:|0|50|100|1:|9.33% |" />'

    assert_select "#cost_hhrr_spent_0", "24797.5 &euro;"
    assert_select "#cost_hhrr_spent_1", "19910.0 &euro;"
    assert_select "#cost_hhrr_spent_2", "12280.0 &euro;"
    assert_select "#cost_other_spent_0", "0.0 &euro;"
    assert_select "#cost_other_spent_1", "0.0 &euro;"
    assert_select "#cost_other_spent_2", "0.0 &euro;"
    assert_select "#cost_total_spent_0", "24797.5 &euro;"
    assert_select "#cost_total_spent_1", "19910.0 &euro;"
    assert_select "#cost_total_spent_2", "12280.0 &euro;"
    assert_select "#cost_hhrr_remaining_0", "32702.5 &euro;"
    assert_select "#cost_hhrr_remaining_1", "37590.0 &euro;"
    assert_select "#cost_hhrr_remaining_2", "34220.0 &euro;"
    assert_select "#cost_other_remaining_0", "0.0 &euro;"
    assert_select "#cost_other_remaining_1", "0.0 &euro;"
    assert_select "#cost_other_remaining_2", "0.0 &euro;"
    assert_select "#cost_total_remaining_0", "32702.5 &euro;"
    assert_select "#cost_total_remaining_1", "37590.0 &euro;"
    assert_select "#cost_total_remaining_2", "34220.0 &euro;"
    ...
    assert_select "#cost_other_planned_0", "0.0 &euro;"
    assert_select "#cost_other_planned_1", "0.0 &euro;"
    assert_select "#cost_other_planned_2", "0.0 &euro;"
    ...
    assert_equal css_select("#cost_chart_0 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:43.13,0.0,43.13|100,100,100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Total: 43.13%|Otros: 0.0%|RRHH: 43.13%|" />'
    assert_equal css_select("#cost_chart_0 img").last.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chd=t:100.0,0.0&chs=250x50&chl=RRHH: 100.0%|Otros: 0.0%|" />'
    assert_equal css_select("#cost_chart_1 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:34.63,0.0,34.63|100,100,100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Total: 34.63%|Otros: 0.0%|RRHH: 34.63%|" />'
    assert_equal css_select("#cost_chart_1 img").last.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chd=t:100.0,0.0&chs=250x50&chl=RRHH: 100.0%|Otros: 0.0%|" />'
    assert_equal css_select("#cost_chart_2 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:26.41,0.0,26.41|100,100,100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Total: 26.41%|Otros: 0.0%|RRHH: 26.41%|" />'
    assert_equal css_select("#cost_chart_2 img").last.to_s, '<img src="http://chart.apis.google.com/chart?cht=p3&chd=t:100.0,0.0&chs=250x50&chl=RRHH: 100.0%|Otros: 0.0%|" />'
    ...
    assert_select "#advance_other_budget_0", "-- %"
    assert_select "#advance_other_budget_1", "-- %"
    assert_select "#advance_other_budget_2", "-- %"
    ...
    assert_equal css_select("#advance_chart_0 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:44.92,33.15,43.13|100,100,100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Coste: 43.13%|Tiempo: 33.15%|Esfuerzo: 44.92%|" />'
    assert_equal css_select("#advance_chart_1 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:35.33,23.2,34.63|100,100,100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Coste: 34.63%|Tiempo: 23.2%|Esfuerzo: 35.33%|" />'
    assert_equal css_select("#advance_chart_2 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:25.74,9.33,26.41|100,100,100&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Coste: 26.41%|Tiempo: 9.33%|Esfuerzo: 25.74%|" />'
    ...
    assert_equal css_select("#profitability_chart_0 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:88.5,76.5,90.0|100,100,100&chp=.5&&chxr=0,-100,100&chm=h,000000,0,0.5,0.5&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|-100|-50|0|50|100|1:|Beneficio actual:80.0%|Prevista actual: 53.0%|Prevista inicial: 77.0%|" />'
    assert_equal css_select("#profitability_chart_1 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:88.5,76.5,92.0|100,100,100&chp=.5&&chxr=0,-100,100&chm=h,000000,0,0.5,0.5&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|-100|-50|0|50|100|1:|Beneficio actual:84.0%|Prevista actual: 53.0%|Prevista inicial: 77.0%|" />'
    assert_equal css_select("#profitability_chart_2 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:88.5,81.0,95.0|100,100,100&chp=.5&&chxr=0,-100,100&chm=h,000000,0,0.5,0.5&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|-100|-50|0|50|100|1:|Beneficio actual:90.0%|Prevista actual: 62.0%|Prevista inicial: 77.0%|" />'
    ...
    assert_equal css_select("#deviation_chart_0 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:5.95,50.0,-2.68|100,100,100&chp=.5&&chxr=0,-100,100&chm=h,000000,0,0.5,0.5&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|-100|-50|0|50|100|1:|Coste: -105.36%|Tiempo: 0.0%|Esfuerzo: -88.1%|" />'
    assert_equal css_select("#deviation_chart_1 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:5.95,50.0,-2.68|100,100,100&chp=.5&&chxr=0,-100,100&chm=h,000000,0,0.5,0.5&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|-100|-50|0|50|100|1:|Coste: -105.36%|Tiempo: 0.0%|Esfuerzo: -88.1%|" />'
    assert_equal css_select("#deviation_chart_2 img").first.to_s, '<img src="http://chart.apis.google.com/chart?cht=bhs&chd=t:21.43,58.565,16.965|100,100,100&chp=.5&&chxr=0,-100,100&chm=h,000000,0,0.5,0.5&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|-100|-50|0|50|100|1:|Coste: -66.07%|Tiempo: 17.13%|Esfuerzo: -57.14%|" />'
    ...
    assert_equal css_select("#risk_chart_0 img").first.to_s, "<img src=\"http://chart.apis.google.com/chart?cht=bhs&chd=t:0,0,0&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Bajo: 0|Medio: 0|Alto: 0|\" />"
    assert_equal css_select("#risk_chart_1 img").first.to_s, "<img src=\"http://chart.apis.google.com/chart?cht=bhs&chd=t:0,0,0&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Bajo: 0|Medio: 0|Alto: 0|\" />"
    assert_equal css_select("#risk_chart_2 img").first.to_s, "<img src=\"http://chart.apis.google.com/chart?cht=bhs&chd=t:0,0,0&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Bajo: 0|Medio: 0|Alto: 0|\" />"
    ...
    assert_equal css_select("#incident_chart_0 img").first.to_s, "<img src=\"http://chart.apis.google.com/chart?cht=bhs&chd=t:0,0,0&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Bajo: 0|Medio: 0|Alto: 0|\" />"
    assert_equal css_select("#incident_chart_1 img").first.to_s, "<img src=\"http://chart.apis.google.com/chart?cht=bhs&chd=t:0,0,0&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Bajo: 0|Medio: 0|Alto: 0|\" />"
    assert_equal css_select("#incident_chart_2 img").first.to_s, "<img src=\"http://chart.apis.google.com/chart?cht=bhs&chd=t:0,0,0&chco=4D89F9,C6D9FD&chbh=10,5,10&chs=250x70&chxt=x,y&chxl=0:|0|50|100|1:|Bajo: 0|Medio: 0|Alto: 0|\" />"
