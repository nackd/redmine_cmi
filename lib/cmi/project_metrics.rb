module CMI
  class ProjectMetrics
    ...
    def calculate
      ...
      @material_current_budget = @project.last_checkpoint.custom_value_for(report_material_current_budget_field).value.to_f rescue 0.0
      @material_original_budget = @project.last_checkpoint.custom_value_for(report_material_original_budget_field).value.to_f rescue 0.0
      ...
      User.roles.each do |role|
        @hr_effort_done[role] = @project.effort_done_by_role(role, @project.last_checkpoint.start_date) rescue 0.0
        ...
        @hr_current_effort_planned[role] = @project.last_checkpoint.custom_value_for(role_current_effort_planned).value.to_f rescue 0.0
      ...
      # TODO Date.tomorrow? why not @project.last_checkpoint.start_date?
