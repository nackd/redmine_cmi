module CMI
  module ProjectCalculations
    ...
    def calculate_time_done project, project_metrics
      time_done = 0.0
      if !project_metrics[Setting.plugin_redmine_cmi['field_project_actual_start_date']].nil?
          time_done = (@date - (Date.parse(project_metrics[Setting.plugin_redmine_cmi['field_project_actual_start_date']])))
      else
          time_done = "--"
      end
