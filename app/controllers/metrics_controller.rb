...
#     begin
    ...
    if !@project.nil? and "#{params[:project_id]}" != "cmi"
      tracker_informes = @project.trackers.find_by_name(DEFAULT_VALUES['tracker']['inform'])
...
#      Esto encuentra el listado de tickets de Gastos
      ...
      tracker_gastos = project.trackers.find_by_name(DEFAULT_VALUES['tracker']['budget'])
